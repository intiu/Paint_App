...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void exportImage ()
    {
        if (canvasExporter.getExportType() == CanvasExporter.FLAG_SAVE)
        {
            ...
            if (fileName != null)
            {
                ...
                Toast.makeText(MainActivity.this, "Hình ảnh đã được lưu thành công.", Toast.LENGTH_SHORT).show();
            } else
            {
                Toast.makeText(MainActivity.this, "Đã xảy ra lỗi khi lưu hình ảnh.", Toast.LENGTH_SHORT).show();
            }
    ...
    private void shareImage()
    {
        ...
        if (image != null)
        {
            ...
            // start the intent
            startActivity(Intent.createChooser(intent, "Chia sẻ hình ảnh qua"));
        } else
        {
            Toast.makeText(MainActivity.this, "Đã xảy ra lỗi khi chia sẻ hình ảnh.", Toast.LENGTH_SHORT).show();
        }
    }
}